...
WBBLANG['en'] = CURLANG = {
	...
	modal_imgsize_text: "Enter the size in pixels <a href='https://www.w3.org/Style/Examples/007/units.en.html'>(What is the Pixels size ?)</a>",
...
//			direction:			"ltr",
			...
			allButtons: {
				...
				img : {
						...
						tabs: [
							{
								...
								input: [
									...
									{param: "SIZE",title:CURLANG.modal_imgsize_text}
								]
							}
						],
					...
					transform : {
						'<img src="{SRC}" />':"[img size={SIZE}px {SRC}[/img]",
						'<img src="{SRC}" width="{SIZE}px"/>':"[img size={SIZE}px]{SRC}[/img]"
					}
				},
				bullist : {
